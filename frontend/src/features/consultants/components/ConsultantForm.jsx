import { BriefcaseBusiness, Mail, Phone, UserPlus, UserRound } from "lucide-react";
...
export function ConsultantForm({
  ...
  return (
    <div className="form-workspace">
      ...
      <aside className="record-preview" aria-label="Consultant record preview">
        <div className="preview-avatar">
          <UserRound size={30} aria-hidden="true" />
        </div>
        <span className={`status-badge ${values.status.toLowerCase()}`}>{preview.status}</span>
        <h3>{preview.name}</h3>
        <p>{preview.technology}</p>
